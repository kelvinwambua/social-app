...
const bannerBgUri = RNImage.resolveAssetSource(bannerBg).uri
const badgeNonprofitUri = RNImage.resolveAssetSource(badgeNonprofit).uri
const badgeOpenUri = RNImage.resolveAssetSource(badgeOpen).uri
